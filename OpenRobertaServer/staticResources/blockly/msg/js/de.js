...
Blockly.Msg.POPUP_ABOUT_TEXT_NRW = "Im Rahmen des Projekts »KI-Algorithmen im Informatikunterricht« fördert das Ministerium für Schule und Bildung des Landes Nordrhein-Westfalen die Integration Künstlicher Neuronaler Netze ins CodeON sowie die Entwicklung passender Lerninhalte und Materialien zu Künstlicher Intelligenz.";
...
Blockly.Msg.POPUP_BACKGROUND_STORAGE = "Wenn du möchtest, laden wir dein Hintergrundbild für die Simulation automatisch bei den nächsten Aufrufen des CodeONs. Dazu speichern wir Daten im Local Storage auf deinem Computer. <a href='https://www.roberta-home.de/datenschutz-open-roberta-lab/' target='_blank'>Mehr dazu in unseren Datenschutzinformationen.</a>";
...
Blockly.Msg.POPUP_RUN_NOTIFICATION = "Damit du dein Programm auf deinen Roboter / Mikrocontroller übertragen kannst, verbinde diesen mit dem CodeON. Wie das geht zeigt dir unsere Anleitung im <a href=\"https://wiki.open-roberta.org\" target=\"_blank\">Open Roberta Wiki</a> unter »Vorbereitung«.";
...
Blockly.Msg.START_STARTUP_TITLE = "Willkommen im CodeON";
Blockly.Msg.START_TEASER = "Auf unserer Open-Source-Plattform »CodeON« erstellst du im Handumdrehen deine ersten Programme per drag and drop.";
...
Blockly.Msg.TOUR1_DESCRIPTION01 = "Herzlich willkommen,<br>mit »weiter« startest du eine Tour durch das CodeON.<br>Ich zeige dir hier, wie du mit NEPO einen Roboter programmieren kannst.<br>Du kannst diese Tour jederzeit beenden. Klicke einfach auf das »X« rechts oben in der Ecke.";
