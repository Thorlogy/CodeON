define(["require", "exports", "guiState.controller", "startView.model", "table", "jquery", "blockly", "tour.controller", "program.controller", "import.controller", "util.roberta", "message", "bootstrap-table"], function (require, exports, GUISTATE_C, STARTVIEW, table_1, $, Blockly, TOUR_C, PROGRAM_C, IMPORT_C, UTIL, MSG) {
    ...
    function init(callback) {
        ...
        var ev3devIndex = robots.findIndex(function (robot) { return robot.name === 'ev3dev'; });
        if (ev3devIndex > -1) {
            var ev3dev = robots.splice(ev3devIndex, 1)[0];
        ...
        var rcxIndex = robots.findIndex(function (robot) { return robot.name === 'rcx'; });
        if (rcxIndex > -1) {
            var rcx = robots.splice(rcxIndex, 1)[0];
            robots.unshift(rcx);
        }
    ...
    function fetchRSSFeed() {
        ...
        var successFn = function (response) {
            var $newsContainer = $('<section class="section--white" id="section--news"><div class="container-fluid"><div class="row justify-content-center"><div class="col col-12 col-xl-10 col-xxl-8 col-xxxl-6 my-4"><div class="teaser-news"><div class="row justify-content-between align-items-center"><div class="col col-12 col-md-6"><div class="teaser-news--header">Neues aus dem CodeON-Projekt</div><div class="teaser-news--body" id="teaser-news--rss"></div></div><div class="col col-12 col-md-6 col-lg-4 offset-md-0 offset-lg-2 mt-5 mt-md-0" id="teaser-news--rss-image"></div></div></div></div></div></div></section>');
