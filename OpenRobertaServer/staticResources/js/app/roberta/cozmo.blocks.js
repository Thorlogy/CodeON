define(['blockly'], function (Blockly) {
    ...
    Blockly.Blocks.cozmoActions_behavior = {
        init: function () {
            ...
            this.setNextStatement(true);
            this.setTooltip(text('Startet Gesichtssuche und Gesichtsfolge mit Sicherheitsstopp. Mit einem Warte- oder Schleifenblock aktiv halten.', 'Starts face search and face following with a safety stop. Keep it active with a wait or loop block.'));
        }
    };
