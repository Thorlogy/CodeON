define(['blockly'], function (Blockly) {
    ...
    Blockly.Blocks.apitorActions_motor = {
        init: function () {
            ...
            this.setTooltip(text(
                'Startet den gewählten Anschluss mit einer der 12 hardwareseitigen Geschwindigkeitsstufen. Ein Warte- oder Stoppblock bestimmt die Laufzeit.',
                'Starts the selected port at one of the 12 hardware speed levels. A wait or stop block determines how long it runs.'
            ));
        }
    };
    ...
    Blockly.Blocks.apitorSensors_colour = {
        init: function () {
            ...
            this.setTooltip(text(
                'Liefert die erkannte Farbe. Vergleiche diesen Block mit einem Farbblock aus der Kategorie Farben.',
                'Returns the detected colour. Compare this block with a colour block from the Colours category.'
            ));
        }
    };
