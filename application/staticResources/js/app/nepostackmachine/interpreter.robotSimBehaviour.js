...
define(["require", "exports", "./interpreter.aRobotBehaviour", "./interpreter.constants", "./interpreter.util", "util.roberta", "simulation.math"], function (require, exports, interpreter_aRobotBehaviour_1, C, U, UTIL, SIMATH) {
    ...
    var RobotSimBehaviour = /** @class */ (function (_super) {
        ...
        RobotSimBehaviour.prototype.driveAction = function (name, direction, speed, distance, time) {
            ...
            if ((direction != C.FOREWARD && direction != C.FORWARD && distance > 0) ||
        ...
        RobotSimBehaviour.prototype.colourCompare = function (colour1, colour2, tolerance) {
            if (colour1.length !== 3 || colour2.length !== 3) {
                return false;
            }
            var hsv1 = SIMATH.rgbToHsv(colour1[0], colour1[1], colour1[2]);
            var hsv2 = SIMATH.rgbToHsv(colour2[0], colour2[1], colour2[2]);
            var hueDistance = Math.min(Math.abs(hsv1[0] - hsv2[0]), 360 - Math.abs(hsv1[0] - hsv2[0]));
