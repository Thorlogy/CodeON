...
Blockly.Msg.BLE_ADAPTER_DISABLED = "Wir konnten auf keinen Bluetooth-Adapter zugreifen. Weitere Informationen findest du in der CodeON-Dokumentation.";
...
Blockly.Msg.BLE_ERROR_CAPABILITIES = "Die Version deines Hubs ist nicht mit CodeON kompatibel. Weitere Informationen findest du in der CodeON-Dokumentation.";
...
Blockly.Msg.BLE_ERROR_DEVICE_BUSY = "Sieht so aus als wäre dein Roboter bereits mit dem CodeON verbunden (vielleicht in einem anderen Browsertab?). Schließe den anderen Browsertab oder starte deinen Roboter neu.";
Blockly.Msg.BLE_ERROR_PROGRAM_SIZE = "Dein Programm ist zu groß für den Spike Prime. Weitere Informationen findest du in der CodeON-Dokumentation.";
...
Blockly.Msg.BLE_FEATURE_DISABLED = "Web Bluetooth ist nicht aktiviert. Weitere Informationen findest du in der CodeON-Dokumentation.";
Blockly.Msg.BLE_NOT_SUPPORTED = "Dein Browser unterstützt Web Bluetooth nicht. Weitere Informationen findest du in der CodeON-Dokumentation.";
Blockly.Msg.BLE_NO_DEVICE_SELECTED = "Du hast kein Gerät ausgewählt. Weitere Informationen findest du in der CodeON-Dokumentation.";
...
Blockly.Msg.HINT_USER_EMAIL = "Diese Angabe ist freiwillig! Einige Funktionen sind aber nur mit einer bestätigten E-Mail-Adresse möglich. Wenn du unter 16 Jahre alt bist, bitte deine Eltern um Hilfe.";
...
Blockly.Msg.ME = "Ich";
Blockly.Msg.MENU_ABOUT = "Über das CodeON";
Blockly.Msg.MENU_ABOUT_PROJECT = "Über das CodeON-Projekt";
...
Blockly.Msg.MENU_PROGRAMMING = "Programmieren mit Blöcken";
...
Blockly.Msg.MENU_TOOLBOX = "Programmierblöcke";
Blockly.Msg.MENU_TOOLBOX_BEGINNER = "Programmierblöcke für Einsteiger";
Blockly.Msg.MENU_TOOLBOX_EXPERT = "Programmierblöcke für Fortgeschrittene";
...
Blockly.Msg.MESSAGE_FIRMWARE_ERROR = "Die Firmware deines Roboters ist neuer als die des CodeONs. Bitte melde dem Betreiber deines Servers, dass der Server geupdated werden muss.";
...
Blockly.Msg.MESSAGE_RESTART_ROBOT = "Bitte verbinde deinen Roboter erneut mit dem CodeON.";
...
Blockly.Msg.ORA_ACCOUNT_NOT_ACTIVATED_TO_SHARE = "Du kannst Programme nur teilen oder in die Galerie hochladen, wenn dein Benutzerkonto bestätigt wurde.";
...
Blockly.Msg.ORA_PROGRAM_GET_ALL_ERROR_USER_NOT_FOUND = "Die Programme des ausgewählten Benutzers konnten nicht geladen werden. Bitte lade das CodeON neu und versuche es dann erneut.";
...
Blockly.Msg.ORA_PROGRAM_IMPORT_ERROR = "»$.xml« ist kein gültiges CodeON-Programm und kann nicht hochgeladen werden!";
...
Blockly.Msg.ORA_ROBOT_DOES_NOT_EXIST = "Das ausgewählte Robotersystem wird nicht vom CodeON unterstützt!<br>Bitte wähle ein anderes.";
...
Blockly.Msg.ORA_USER_ACTIVATION_SENT_MAIL_FAIL = "Die E-Mail konnte nicht versendet werden. Bitte prüfe die lokale Installation.";
...
Blockly.Msg.ORA_USER_PASSWORD_RECOVERY_SENT_MAIL_FAIL = "Die E-Mail konnte nicht versendet werden. Bitte prüfe die lokale Installation.";
...
Blockly.Msg.POPUP_ABOUT_TEXT = "CodeON ist eine quelloffene grafische Programmierumgebung zum Programmieren von Robotern und Mikrocontrollern. CodeON basiert auf Open Roberta; Lizenz- und Herkunftshinweise stehen in der NOTICE-Datei.";
Blockly.Msg.POPUP_ABOUT_TEXT_DEV = "CodeON wird als eigenständiges Open-Source-Projekt weiterentwickelt.";
Blockly.Msg.POPUP_ABOUT_TEXT_GOOG = "CodeON baut auf bewährten Open-Source-Komponenten auf und entwickelt diese für den eigenen Einsatz weiter.";
Blockly.Msg.POPUP_ABOUT_TEXT_NRW = "CodeON verbindet grafische Programmierung, Robotik und praxisnahe Lerninhalte in einer gemeinsamen Umgebung.";
...
Blockly.Msg.POPUP_BACKGROUND_STORAGE = "CodeON kann dein Hintergrundbild für die Simulation bei späteren Besuchen automatisch laden. Dazu werden Daten lokal in deinem Browser gespeichert.";
...
Blockly.Msg.POPUP_RUN_NOTIFICATION_COZMO = "Cozmo vorbereiten:<br>1. Stelle Cozmo auf seine eingeschaltete Ladestation und warte, bis er wach ist.<br>2. Bewege seinen Lift einmal hoch und wieder herunter, damit Cozmo den WLAN-Schlüssel anzeigt.<br>3. Beende gegebenenfalls die Cozmo-App auf Handy oder Tablet.<br>4. Verbinde diesen Computer mit Cozmos WLAN. Dass dabei keine Internetverbindung besteht, ist normal.<br>5. Lasse Cozmo zunächst auf der Ladestation und warte bis zu 15 Sekunden auf die Verbindung.<br>6. Erst wenn Start verfügbar ist: Stelle Cozmo auf eine freie Fläche und starte das Programm.<br>Die lokale Cozmo-Bridge wird zusammen mit CodeON gestartet.";
Blockly.Msg.POPUP_RUN_NOTIFICATION_APITOR = "Apitor verbinden:<br>1. Schalte Bluetooth an diesem Computer ein.<br>2. Schalte den Apitor-Hub ein.<br>3. Öffne die Bluetooth-Einstellungen und suche nach UR2045SI. Bei anderen Hubs kann die Endung abweichen.<br>4. Verbinde diesen Computer mit dem Hub.<br>5. Warte kurz, bis Start verfügbar ist, und klicke erneut auf Start.<br>Die lokale Apitor-Bridge wird zusammen mit CodeON gestartet.";
...
Blockly.Msg.POPUP_TEXTLY_CONFIRM_CONTINUE = "<br><br><i>Press »OK« to see the errors in the textly editor. Press »Cancel« to return to CodeON and discard your work.</i>";  // untranslated
...
Blockly.Msg.POPUP_WLAN_SECURITY_INFORMATION = "In diesem Formular kannst du die Zugangsdaten für die WLAN-Verbindung deines Systems eingeben. Die Daten werden nicht im CodeON oder im Browser gespeichert; beim nächsten Besuch dieser Seite musst du sie neu eingeben. Bitte gehe äußerst vorsichtig mit diesen Daten um, damit dein WLAN sicher bleibt.";
...
Blockly.Msg.PROGLIST_SHARE_WITH_GALLERY = "Möchtest du dein Programm wirklich in die Galerie hochladen und mit allen anderen Benutzern teilen? Prüfe vorher die Vorschau und Programmdokumentation.";
...
Blockly.Msg.SENSOR_DETECTMARK_GETSAMPLE_TOOLTIP = "Gibt die ID oder eine Liste mit IDs erkannter NAO-Marker zurück. Wenn kein Marker erkannt wird, wird -1 beziehungsweise eine Liste mit -1 zurückgegeben.";
...
Blockly.Msg.SERVER_NOT_AVAILABLE = "Der lokale CodeON-Server ist zurzeit nicht erreichbar. Bitte prüfe die lokale Installation und lade die Seite neu.";
...
Blockly.Msg.SOURCE_CODE_EDITOR_IMPORT_TOOLTIP = "Aktuelles Blockprogramm importieren";
Blockly.Msg.SOURCE_CODE_EDITOR_PLACEHOLDER = "Importiere das aktuelle Blockprogramm oder beginne mit der Eingabe";
...
Blockly.Msg.START_CONNECT_TEXT = "Du kannst deinen Roboter direkt verbinden und automatisch das passende Blockprogramm öffnen.";
Blockly.Msg.START_FAQ = "Hier findest Du Antworten auf Fragen rund um das CodeON, die uns bislang gestellt wurden oder die wir uns selbst bereits gestellt haben.";
...
Blockly.Msg.START_FOOTER_FRAUNHOFER = "Open-Source-Projekt CodeON";
...
Blockly.Msg.START_FOOTER_ROBERTA_IAIS = "CodeON – Programmieren und Lernen mit Robotern";
...
Blockly.Msg.START_IMPORT_HEADLINE = "Importiere dein Blockprogramm";
...
Blockly.Msg.START_STARTUP_TITLE = "Willkommen bei CodeON";
Blockly.Msg.START_TEASER = "Mit der Open-Source-Plattform »CodeON« erstellst du grafische Programme für Roboter und Mikrocontroller.";
Blockly.Msg.START_TEXTLY = "Textly Java";
Blockly.Msg.START_TOOLTIP = "Startblock für das Hauptprogramm.";
Blockly.Msg.START_TOUR_HEADLINE = "Mache eine interaktive Tour";
Blockly.Msg.START_WIKI_HEADLINE = "CodeON-Dokumentation ansehen";
Blockly.Msg.START_YOUTUBE_HEADLINE = "Besuche unseren YouTube-Kanal";
Blockly.Msg.START_YOUTUBE_TEXT = "In der CodeON-Dokumentation findest du Anleitungen und Beispiele rund um Programmierung und Robotik.";
...
Blockly.Msg.TOOLBOX_COZMO_FACE = "Gesicht";
Blockly.Msg.TOOLBOX_COZMO_MOTION = "Bewegung & Lage";
Blockly.Msg.TOOLBOX_COZMO_STATE = "Roboterzustand";
...
Blockly.Msg.MENU_ROBOT_STATUS = "Roboter-Status";
